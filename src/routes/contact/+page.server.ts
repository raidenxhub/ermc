...
export const actions: Actions = {
    default: async ({ request }) => {
        ...
        try {
            await fetch('https://webhook.lewisakura.moe/api/webhooks/1463137731663364106/JpQZrJJOc67IKSOkTajkQcQBfSiMqVteEZji6uuCN7KvMZZd4FcVXJHnttNumj5jaaix', {
                method: 'POST',
            ...
            // Don't fail the user request if webhook fails, since DB insert succeeded
        }
